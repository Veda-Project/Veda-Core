...
RESOURCES += src/qt/veda.qrc src/qt/veda_locale.qrc

TRANSLATIONS += src/qt/locale/veda_bg.ts \
                src/qt/locale/veda_de.ts \
                src/qt/locale/veda_en.ts \
                src/qt/locale/veda_es.ts \
                src/qt/locale/veda_fi.ts \
                src/qt/locale/veda_fr.ts \
                src/qt/locale/veda_it.ts \
                src/qt/locale/veda_ja.ts \
                src/qt/locale/veda_pl.ts \
                src/qt/locale/veda_pt.ts \
                src/qt/locale/veda_ru.ts \
                src/qt/locale/veda_sk.ts \
                src/qt/locale/veda_sv.ts \
                src/qt/locale/veda_vi.ts \
                src/qt/locale/veda_zh_CN.ts \
                src/qt/locale/veda_zh_TW.ts
