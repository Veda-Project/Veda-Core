...
In order to support loading of multiple wallets in veda-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is veda.cpp.
...
Changes to veda.cpp
----------------------
veda.cpp is the entry point into veda-qt, and as such, will require some minor modifications to provide hooks for
