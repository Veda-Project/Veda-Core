...
This mechanism has been integrated into Bitcore-Node-VEDA which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/VEDA-Project/insight-api-veda#web-socket-api](https://github.com/VEDA-Project/insight-api-veda#web-socket-api) 
* API: [https://github.com/VEDA-Project/insight-api-veda#swifttx-transactions](https://github.com/VEDA-Project/insight-api-veda#swifttx-transactions) 
...
By default, the VEDA Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the VEDA Core daemon:
