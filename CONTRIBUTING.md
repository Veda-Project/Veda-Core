Contributing to VEDA Core
============================

The VEDA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VEDA Core project, and is not to be
confused with overall VEDA Network Protocol consensus changes.

Whether a pull request is merged into VEDA Core rests with the project merge
...
Patches that change VEDA consensus rules are considerably more involved than
...
Where a patch set proposes to change the VEDA consensus, it must have been
...
The project leader is the release manager for each VEDA Core release.
