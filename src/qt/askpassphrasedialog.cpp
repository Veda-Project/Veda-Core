                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zVEDA || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending VEDA because you wouldn't check it anyway.
    if (context == Context::Send_VEDA || context == Context::Send_zVEDA) {
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("VEDA will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your VEDAs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
