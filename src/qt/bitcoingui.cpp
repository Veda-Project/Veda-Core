                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("VEDA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VEDA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and veda: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zVEDA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VEDA Core"), this);
    aboutAction->setStatusTip(tr("Show information about VEDA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VEDA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VEDA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VEDA addresses"));
    ...
    openAction->setStatusTip(tr("Open a VEDA: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the VEDA Core help message to get a list with possible VEDA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("VEDA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VEDA network", "", count));
}
...
{
    QString strTitle = tr("VEDA Core"); // default title
