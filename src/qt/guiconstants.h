...
/* Veda GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "VEDA"
#define QAPP_ORG_DOMAIN "veda.org"
#define QAPP_APP_NAME_DEFAULT "VEDA-Qt"
#define QAPP_APP_NAME_TESTNET "VEDA-Qt-testnet"
