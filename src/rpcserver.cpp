...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VEDA features */
        {"veda", "masternode", &masternode, true, true, false},
        {"veda", "listmasternodes", &listmasternodes, true, true, false},
        {"veda", "getmasternodecount", &getmasternodecount, true, true, false},
        {"veda", "masternodeconnect", &masternodeconnect, true, true, false},
        {"veda", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"veda", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"veda", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"veda", "masternodecurrent", &masternodecurrent, true, true, false},
        {"veda", "masternodedebug", &masternodedebug, true, true, false},
        {"veda", "startmasternode", &startmasternode, true, true, false},
        {"veda", "createmasternodekey", &createmasternodekey, true, true, false},
        {"veda", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"veda", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"veda", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"veda", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"veda", "getmasternodescores", &getmasternodescores, true, true, false},
        {"veda", "mnbudget", &mnbudget, true, true, false},
        {"veda", "preparebudget", &preparebudget, true, true, false},
        {"veda", "submitbudget", &submitbudget, true, true, false},
        {"veda", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"veda", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"veda", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"veda", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"veda", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"veda", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"veda", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"veda", "checkbudgets", &checkbudgets, true, true, false},
        {"veda", "mnsync", &mnsync, true, true, false},
        {"veda", "spork", &spork, true, true, false},
        {"veda", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> veda-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:53993/\n";
}
